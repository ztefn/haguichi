...
public static class Hamachi
{
    ...
    public static void Configure ()
    {
        ...
        string output = Command.ReturnOutput ( ( string ) Config.Client.Get ( Config.Settings.CommandForSuperUser ), Command.SudoArguments + Command.SudoStart + "bash -c \"echo \'Ipc.User      " + System.Environment.UserName + "\' >> /var/lib/logmein-hamachi/h2-engine-override.cfg; " + ScriptDirectory + "/logmein-hamachi restart --skip-redirect\"" + Command.SudoEnd );
    ...
    public static string Start ()
    {
        ...
        string output = Command.ReturnOutput ( ( string ) Config.Client.Get ( Config.Settings.CommandForSuperUser ), Command.SudoArguments + Command.SudoStart + ScriptDirectory + "/logmein-hamachi start --skip-redirect" + Command.SudoEnd );
    ...
    public static string Stop ()
    {
        ...
        string output = Command.ReturnOutput ( ( string ) Config.Client.Get ( Config.Settings.CommandForSuperUser ), Command.SudoArguments + Command.SudoStart + ScriptDirectory + "/logmein-hamachi stop --skip-redirect" + Command.SudoEnd );
