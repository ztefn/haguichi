 ...
 * Copyright © 2007-2025 Stephen Brandt <stephen@stephenbrandt.com>
 * 
...
public static class TextStrings
{
    ...
    public static string appCopyright           = "Copyright © 2007-2025 Stephen Brandt";
...
";
    ...
    public static void Init ()
    {
        ...
        conflict                            = Catalog.GetString ( "Conflicting address" );
