...
public class Text : Object
{
    ...
    public const  string app_website               = "https://haguichi.net";
    ...
    public const  string app_copyright             = "Copyright © 2007–2020 Stephen Brandt";
...
Copyright © 2007–2020 Stephen Brandt <stephen@stephenbrandt.com>""";
