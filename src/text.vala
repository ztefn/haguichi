...
public class Text : Object
{
    ...
    public const  string app_version               = "1.3.4";
    ...
    public const  string app_copyright             = "Copyright © 2007–2016 Stephen Brandt";
...
Copyright © 2007–2016 Stephen Brandt <stephen@stephenbrandt.com>";
