...
public class Hamachi : Object
{
    ...
    {
        string output = Command.return_output (Command.sudo + " " + Command.sudo_args + Command.sudo_start + "bash -c \"" + Utils.format (service, "start", null, null) + "; echo \'Ipc.User      " + GLib.Environment.get_user_name() + "\' >> " + config_path + "; " + Utils.format (service, "restart", null, null) + "; sleep 1\"");
    ...
    public static void restore_config (string filename)
    {
        ...
        if (output.contains (Hamachi.data_path))
        {
            ...
            output = Command.return_output (Command.sudo + " " + Command.sudo_args + Command.sudo_start + "bash -c \"" + Utils.format (service, "stop", null, null) + "; sleep 1; rm " + Hamachi.data_path + "/*; tar -xavf '" + filename + "' -C /; sleep 1; " + Utils.format (service, "start", null, null) + "; sleep 1\"");
