...
public class Hamachi : Object
{
    ...
    public static void restore_config (string filename)
    {
        ...
        if (output.contains (Hamachi.data_path))
        {
            ...
            output = Command.return_output (Command.sudo + " " + Command.sudo_args + Command.sudo_start + "bash -c \"" + Utils.format (service, "stop", null, null) + "; sleep 1; rm " + Hamachi.data_path + "/*; tar -xavf '" + filename + "' -C /; " + Utils.format (service, "restart", null, null) + "; sleep 1\"");
