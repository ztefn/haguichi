...
public class Hamachi : Object
{
    ...
    {
        string output = Command.return_output (Command.sudo + " " + Command.sudo_args + Command.sudo_start + "bash -c \"mkdir -p " + data_path + "; echo \'Ipc.User      " + GLib.Environment.get_user_name() + "\' >> " + config_path + "; " + Utils.format (service, "restart", null, null) + "; sleep 1\"");
